      ...
      <MDBContainer className={styles.nav} fluid >
        ...
        <MDBCollapse navbar     show={showNavSecond}>
          <MDBNavbarNav>
            ...
            <MDBNavbarLink href='/AdminManagement' active  nav-link>Dealers Management</MDBNavbarLink>
            <MDBNavbarLink href='/AdminPendingRequest'   nav-link>Pending Requests</MDBNavbarLink>
